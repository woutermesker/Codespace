                  ...
                  <ul class="grid2">
                    <li>
                      <div class="item">
                        ...
                        <div class="item__text">New API Endpoints</div>
                      </div>
                    </li>
                    <li>
                      <div class="item">
                        ...
                        <div class="item__text">More Secure</div>
                      </div>
                    </li>
                    <li>
                      <div class="item">
                        ...
                        <div class="item__text">Better Insights</div>
                      </div>
                    </li>
                    <li>
                      <div class="item">
                        ...
                        <div class="item__text">New Technologies</div>
                      </div>
                    </li>
                    <li>
                      <div class="item">
                        ...
                        <div class="item__text">More Teams onboarded</div>
                      </div>
                    </li>
                    <li>
                      <div class="item">
                        ...
                        <div class="item__text">New Team Members!</div>
                      </div>
                    </li>
                    <li>
                      <div class="item">
                        ...
                        <div class="item__text">SDLC control insights</div>
                      </div>
                    </li>
                    <li>
                      <div class="item">
                        ...
                        <div class="item__text">Better Workforce insights</div>
                      </div>
                    </li>
                    <li>
                      <div class="item">
                        ...
                        <div class="item__text">Like like like!</div>
                      </div>
                    </li>
                    <li>
                      <div class="item">
                        ...
                        <div class="item__text">New Functionality</div>
                      </div>
                    </li>
                    <li>
                      <div class="item">
                        ...
                        <div class="item__text">Track Dora insights</div>
                      </div>
                    </li>
                    <li>
                      <div class="item">
                        ...
                        <div class="item__text">Customize your views</div>
                      </div>
                    </li>
                  </ul>
                </div>
          ...
          <div className="pb-4 pt-5 pt-md-7 col-12 col-md-5 position-relative">
            <div className="changelog-single-details position-sticky top-12">
              ...
              <h2 className="h5-mktg">
                <a href="">Copilot Dashboard added to HEET</a>
              </h2>
              <time
                datetime="2024-05-09"
              ...
              <ul className="d-inline-block list-style-none post-hero__categories mt-2">
                <li className="d-inline-block mr-2 mt-2">
                  <a
                    href=""
          ...
          <div className="col-12 col-md-7">
            <div className="pb-5 pt-0 py-md-7 changelog-single-content-wrap border-bottom">
              ...
              >
                ...
                efficitur sapien. In hac habitasse platea dictumst. Vestibulum
                ante ipsum primis in faucibus orci luctus et ultrices posuere
                cubilia curae. */ Lorem ipsum dolor sit amet, consectetur
                adipiscing elit. Sed ac efficitur sapien. In hac habitasse
                platea dictumst. Vestibulum ante ipsum primis in faucibus orci
                luctus et ultrices posuere cubilia curae. */ Lorem ipsum dolor
                sit amet, consectetur adipiscing elit. Sed ac efficitur sapien.
        ...
        >
          <div className="pb-4 pt-5 pt-md-7 col-12 col-md-5 position-relative">
            <div className="changelog-single-details position-sticky top-12">
              ...
              <h2 className="h5-mktg">
                <a href="">FQDNs now available in the EIM Tab</a>
              </h2>
              <time
                datetime="2024-05-09"
                className="d-block f5-mktg text-medium color-fg-muted mt-14px"
        ...
        >
          <div className="pb-4 pt-5 pt-md-7 col-12 col-md-5 position-relative">
            <div className="changelog-single-details position-sticky top-12">
              ...
              <h2 className="h5-mktg">
                <a href="">Title for third update</a>
              </h2>
              <time
                datetime="2024-05-09"
                className="d-block f5-mktg text-medium color-fg-muted mt-14px"
        ...
        >
          <div className="pb-4 pt-5 pt-md-7 col-12 col-md-5 position-relative">
            <div className="changelog-single-details position-sticky top-12">
              ...
              <h2 className="h5-mktg">
                <a href="">Title for fourth update</a>
              </h2>
              <time
                datetime="2024-05-09"
                className="d-block f5-mktg text-medium color-fg-muted mt-14px"
